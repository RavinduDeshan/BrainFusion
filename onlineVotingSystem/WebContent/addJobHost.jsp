        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" action="AddJobHostServlet">
                        <div class="form-row">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="form-input">
                                    <label for="company" class="required">WebSite</label>
                                    <input type="text" name="web" id="web" />
                                </div>
                                
                                <div class="form-input">
                                    <label for="first_name" class="required">Company Address</label>
                                    <input type="text" name="address" id="address" />
                                </div>
                               
                                
                                <div class="form-input">
                                    <label for="company" class="required">Description About Company</label>
