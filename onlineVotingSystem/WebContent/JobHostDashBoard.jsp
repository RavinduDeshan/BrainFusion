...
<head>
  ...
  <title>Job Hoster| Admin Panel</title>
  <!-- Font Awesome -->
...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="addJob.jsp" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-user mr-3"></i>Add Jobs</a>
        
          <i></i><form action="SignOutServlet" method="post"><input type="submit" value="LogOut" class="btn btn-danger" style="margin-top: 7px;"></form>
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid">
      <div aria-placeholder="center"><h1><b>Career Master</b></div>
      <!-- Heading -->
     ...
     <div class="SearchTable">
      ...
      <tbody>
       ...
       <%  
			...
			String sqls="select * from job where cemail ='" +email+"' ";
			...
			<tr>
				...
				<td>
					...
					<form action="SearchJobServlet" method="Post">
					
					<input type="hidden" name="editid" value="<%=results.getString("code") %>">
					...
					<input type="hidden" name="deleteid" value="<%=results.getString("code") %>">
      ...
      <%}}
    	  ...
    	  if(scontent!=null){
    		  ...
    		  sqls="select * from job where  cemail='" +email+"' and note like '%"+scontent+"%' or type like '%"+scontent+"%' or title like '%"+scontent+"%' or email like '%"+scontent+"%' or web like '%"+scontent+"%' or code like '%"+scontent+"%'" ;
